...
public class Pregunta9Activity extends AppCompatActivity {
    TextView txtConometroP9, txtPregunta9;
...
// Mapear elementos
        txtConometroP9 = (TextView) findViewById(R.id.txtConometro);
        txtPregunta9 = (TextView) findViewById(R.id.txtPregunta);
...
// Asignar pregunta traida de la base de datos
    ...
    public void asignarPregunta() {
        try {
            Cursor pregunta = bdd.obtenerPregunta(9);
            if (pregunta != null) {
                String preg = pregunta.getString(1).toString();
                txtPregunta9.setText(preg);
            }
        } catch (Exception ex) {
    ...
    private void newCronometro() {
        ...
        cronometro = new CountDownTimer(tiempoRestante, intervalo) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                txtConometroP9.setText(String.valueOf(millisUntilFinished / 1000)); // Dividimos para mil ya que el tiempo entregado es en milisegundos
            }
...
//                Toast.makeText(Pregunta1Activity.this, "Tiempo terminado!", Toast.LENGTH_LONG).show();
    ...
    public void respondeBien(View vista) {
        ...
        Intent seguirPregunta10 = new Intent(getApplicationContext(), Pregunta10Activity.class);
        puntuacion++;
        seguirPregunta10.putExtra("puntuacion", "" + puntuacion);
        startActivity(seguirPregunta10);
        cronometro.cancel();
    }
