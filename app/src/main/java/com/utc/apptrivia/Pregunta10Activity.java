...
public class Pregunta10Activity extends AppCompatActivity {
    TextView txtConometroP10, txtPregunta10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Mapear elementos
        txtConometroP10 = (TextView) findViewById(R.id.txtConometro);
        txtPregunta10 = (TextView) findViewById(R.id.txtPregunta);
...
// Asignar pregunta traida de la base de datos
    ...
    public void asignarPregunta() {
        try {
            Cursor pregunta = bdd.obtenerPregunta(10);
            if (pregunta != null) {
                String preg = pregunta.getString(1).toString();
                txtPregunta10.setText(preg);
            }
        } catch (Exception ex) {
    ...
    private void newCronometro() {
        ...
        cronometro = new CountDownTimer(tiempoRestante, intervalo) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                txtConometroP10.setText(String.valueOf(millisUntilFinished / 1000)); // Dividimos para mil ya que el tiempo entregado es en milisegundos
            }
...
//                Toast.makeText(Pregunta1Activity.this, "Tiempo terminado!", Toast.LENGTH_LONG).show();
    ...
    public void respondeBien(View vista) {
        ...
        Intent pantallaResultados = new Intent(getApplicationContext(), ResultadosActivity.class);
        puntuacion++;
        pantallaResultados.putExtra("puntuacion", "" + puntuacion);
