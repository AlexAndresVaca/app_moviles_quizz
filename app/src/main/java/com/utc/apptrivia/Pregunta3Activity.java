...
public class Pregunta3Activity extends AppCompatActivity {
    ...
    TextView txtConometroP3, txtPregunta3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Mapear elementos
        txtConometroP3 = (TextView) findViewById(R.id.txtConometro);
        txtPregunta3 = (TextView) findViewById(R.id.txtPregunta);
...
// Asignar pregunta traida de la base de datos
    ...
    public void asignarPregunta() {
        try {
            Cursor pregunta = bdd.obtenerPregunta(3);
            if (pregunta != null) {
                String preg = pregunta.getString(1).toString();
                txtPregunta3.setText(preg);
            }
        } catch (Exception ex) {
    ...
    private void newCronometro() {
        ...
        cronometro = new CountDownTimer(tiempoRestante, intervalo) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                txtConometroP3.setText(String.valueOf(millisUntilFinished / 1000)); // Dividimos para mil ya que el tiempo entregado es en milisegundos
            }
...
//                Toast.makeText(Pregunta1Activity.this, "Tiempo terminado!", Toast.LENGTH_LONG).show();
    ...
    public void respondeBien(View vista) {
        ...
        Intent seguirPregunta4 = new Intent(getApplicationContext(), Pregunta4Activity.class);
        puntuacion++;
        seguirPregunta4.putExtra("puntuacion", "" + puntuacion);
        startActivity(seguirPregunta4);
        cronometro.cancel();
    }
