...
public class Pregunta7Activity extends AppCompatActivity {
    //    Definicion de atributos
    TextView txtConometroP7, txtPregunta7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Mapear elementos
        txtConometroP7 = (TextView) findViewById(R.id.txtConometro);
        txtPregunta7 = (TextView) findViewById(R.id.txtPregunta);
...
// Asignar pregunta traida de la base de datos
    ...
    public void asignarPregunta() {
        try {
            Cursor pregunta = bdd.obtenerPregunta(7);
            if (pregunta != null) {
                String preg = pregunta.getString(1).toString();
                txtPregunta7.setText(preg);
            }
        } catch (Exception ex) {
    ...
    private void newCronometro() {
        ...
        cronometro = new CountDownTimer(tiempoRestante, intervalo) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                txtConometroP7.setText(String.valueOf(millisUntilFinished / 1000)); // Dividimos para mil ya que el tiempo entregado es en milisegundos
            }
...
//                Toast.makeText(Pregunta1Activity.this, "Tiempo terminado!", Toast.LENGTH_LONG).show();
    ...
    public void respondeBien(View vista) {
        ...
        Intent seguirPregunta8 = new Intent(getApplicationContext(), Pregunta8Activity.class);
        puntuacion++;
        seguirPregunta8.putExtra("puntuacion", "" + puntuacion);
        startActivity(seguirPregunta8);
        cronometro.cancel();
    }
