...
public class Pregunta2Activity extends AppCompatActivity {
    ...
    TextView txtConometroP2, txtPregunta2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Mapear elementos
        txtConometroP2 = (TextView) findViewById(R.id.txtConometro);
        txtPregunta2 = (TextView) findViewById(R.id.txtPregunta);
    ...
    public void asignarPregunta() {
        try {
            Cursor pregunta = bdd.obtenerPregunta(2);
            if (pregunta != null) {
                String preg = pregunta.getString(1).toString();
                txtPregunta2.setText(preg);
            }
        } catch (Exception ex) {
    ...
    private void newCronometro() {
        ...
        cronometro = new CountDownTimer(tiempoRestante, intervalo) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                txtConometroP2.setText(String.valueOf(millisUntilFinished / 1000)); // Dividimos para mil ya que el tiempo entregado es en milisegundos
            }
...
//                Toast.makeText(Pregunta1Activity.this, "Tiempo terminado!", Toast.LENGTH_LONG).show();
    ...
    public void respondeBien(View vista) {
        ...
        Intent seguirPregunta3 = new Intent(getApplicationContext(), Pregunta3Activity.class);
        puntuacion++;
        seguirPregunta3.putExtra("puntuacion", "" + puntuacion);
        startActivity(seguirPregunta3);
        cronometro.cancel();
    }
