...
public class Pregunta4Activity extends AppCompatActivity {
    ...
    TextView txtConometroP4, txtPregunta4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Mapear elementos
        txtConometroP4 = (TextView) findViewById(R.id.txtConometro);
        txtPregunta4 = (TextView) findViewById(R.id.txtPregunta);
...
// Asignar pregunta traida de la base de datos
    ...
    public void asignarPregunta() {
        try {
            Cursor pregunta = bdd.obtenerPregunta(4);
            if (pregunta != null) {
                String preg = pregunta.getString(1).toString();
                txtPregunta4.setText(preg);
            }
        } catch (Exception ex) {
    ...
    private void newCronometro() {
        ...
        cronometro = new CountDownTimer(tiempoRestante, intervalo) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                txtConometroP4.setText(String.valueOf(millisUntilFinished / 1000)); // Dividimos para mil ya que el tiempo entregado es en milisegundos
            }
...
//                Toast.makeText(Pregunta1Activity.this, "Tiempo terminado!", Toast.LENGTH_LONG).show();
    ...
    public void respondeBien(View vista) {
        ...
        Intent seguirPregunta5 = new Intent(getApplicationContext(), Pregunta5Activity.class);
        puntuacion++;
        seguirPregunta5.putExtra("puntuacion", "" + puntuacion);
        startActivity(seguirPregunta5);
        cronometro.cancel();
    }
